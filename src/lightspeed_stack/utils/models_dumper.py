...
conversation_summary_models: list[type[BaseModel]] = [
    lightspeed_stack.models.compaction.ConversationSummary
]
...
successful_responses_models: list[type[BaseModel]] = [
    ...
    lightspeed_stack.models.api.responses.successful.SavedPromptDeleteResponse,
    lightspeed_stack.models.api.responses.successful.SavedPromptResponse,
    lightspeed_stack.models.api.responses.successful.SavedPromptsListResponse,
