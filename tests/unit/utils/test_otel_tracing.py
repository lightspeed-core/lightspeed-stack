...
@pytest.fixture(name="otel_secret", autouse=True)
def otel_secret_fixture(monkeypatch):
    """Set OTEL_ANONYMIZATION_SECRET for all tests in this module."""
    monkeypatch.setenv("OTEL_ANONYMIZATION_SECRET", "test-secret-for-unit-tests")
