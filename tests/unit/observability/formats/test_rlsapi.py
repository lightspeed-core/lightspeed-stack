...
from lightspeed_stack.observability.formats.rlsapi import InferenceEventData, build_inference_event
...
def test_builds_event_with_all_fields(
    ...
    mock_config = mocker.patch("lightspeed_stack.observability.formats.rlsapi.configuration")
