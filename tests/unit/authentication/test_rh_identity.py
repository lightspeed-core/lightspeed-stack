...
from lightspeed_stack.authentication.rh_identity import RHIdentityAuthDependency, RHIdentityData
...
class TestRHIdentityData:
    ...
    def test_validation_failures(
        ...
        mock_warning = mocker.patch("lightspeed_stack.authentication.rh_identity.logger.warning")
...
class TestRHIdentityHealthProbeSkip:
    ...
    def _mock_configuration(
        ...
        mocker.patch("lightspeed_stack.authentication.rh_identity.configuration", mock_config)
