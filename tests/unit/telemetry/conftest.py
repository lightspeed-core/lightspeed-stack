...
# New PII values for extended sections
PII_CACHE_SQLITE_PATH = "/var/lib/lightspeed/cache.sqlite"
PII_CACHE_PG_HOST = "cache-db.internal.corp.com"
PII_CACHE_PG_DB = "cache_prod"
PII_CACHE_PG_USER = "cache_user"
PII_CACHE_PG_PASS = "CacheP@ss!Secret"
PII_CACHE_PG_NAMESPACE = "cache_ns"
PII_CACHE_PG_CA_CERT = "/etc/ssl/cache-postgres/ca.crt"
PII_QUOTA_SQLITE_PATH = "/var/lib/lightspeed/quota.sqlite"
PII_QUOTA_PG_HOST = "quota-db.internal.corp.com"
PII_QUOTA_PG_DB = "quota_prod"
PII_QUOTA_PG_USER = "quota_user"
PII_QUOTA_PG_PASS = "QuotaP@ss!Secret"
PII_QUOTA_PG_NAMESPACE = "quota_ns"
PII_QUOTA_PG_CA_CERT = "/etc/ssl/quota-postgres/ca.crt"
PII_BYOK_DB_PATH = "/var/lib/lightspeed/byok.faiss"
PII_BYOK_PG_HOST = "byok-db.internal.corp.com"
PII_BYOK_PG_DB = "byok_prod"
PII_BYOK_PG_USER = "byok_user"
PII_BYOK_PG_PASS = "ByokP@ss!Secret"
PII_A2A_SQLITE_PATH = "/var/lib/lightspeed/a2a.sqlite"
PII_A2A_PG_HOST = "a2a-db.internal.corp.com"
PII_A2A_PG_DB = "a2a_prod"
PII_A2A_PG_USER = "a2a_user"
...
PII_AZURE_TENANT_ID = "azure-tenant-id-secret-99999"
PII_AZURE_CLIENT_ID = "azure-client-id-secret-88888"
PII_AZURE_CLIENT_SECRET = "azure-client-secret-77777"
PII_PROFILE_PATH = "/etc/lightspeed/custom_profile.py"
PII_AGENT_CARD_PATH = "/etc/lightspeed/agent_card.yaml"
PII_OKP_URL = "https://okp.internal.corp.com"
PII_SKILLS_PATH = "/etc/lightspeed/skills"
PII_AUTH_API_KEY = "auth-api-key-secret-12345"
PII_LLAMA_PROFILE_PATH = "/etc/lightspeed/llama_profile.yaml"
    ...
    return Configuration.model_construct(
        ...
        llama_stack=LlamaStackConfiguration.model_construct(
            ...
            config=UnifiedLlamaStackConfig.model_construct(
                baseline="default",
                profile=PII_LLAMA_PROFILE_PATH,
                native_override={},
            ),
        ),
        ...
        authentication=AuthenticationConfiguration.model_construct(
            ...
            api_key_config=APIKeyTokenConfiguration.model_construct(
                api_key=SecretStr(PII_AUTH_API_KEY),
            ),
            rh_identity_config=RHIdentityConfiguration.model_construct(
                required_entitlements=["insights", "openshift"],
        ...
        mcp_servers=[
            ModelContextProtocolServer.model_construct(
                ...
                url=PII_MCP_URL,
                authorization_headers={"Authorization": "/etc/mcp/token.txt"},
        ...
        byok_rag=[
            ByokRag.model_construct(
                ...
                host=PII_BYOK_PG_HOST,
                port="5432",
                db=PII_BYOK_PG_DB,
                user=PII_BYOK_PG_USER,
                password=SecretStr(PII_BYOK_PG_PASS),
            ),
        ],
        ...
        quota_handlers=QuotaHandlersConfiguration.model_construct(
            ...
            scheduler=QuotaSchedulerConfiguration.model_construct(
                period=5,
                database_reconnection_count=20,
        ...
        okp=OkpConfiguration.model_construct(
            ...
            offline=True,
            chunk_filter_query="product:ansible",
        ),
